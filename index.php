...
if(isset($_SESSION['userId'])) {
	header('location: http://localhost/2022/inventario/dashboard.php');	
	/*header('location: http://localhost/2022/inventario/dashboard.php');*/
}
	...
	if(empty($username) || empty($password)) {
		...
		if($result->num_rows == 1) {
			...
			if($mainResult->num_rows == 1) {
				...
				header('location: http://localhost/2022/inventario/dashboard.php');	
				//header('location: http://localhost/inventario/dashboard.php');
			} else{
				
				$errors[] = "Usuasio o contraseña no coinciden";
			} // /else
		} else {		
