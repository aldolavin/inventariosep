	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Catalogo de Marca</div>
			</div> <!-- /panel-heading -->
    	...
    	<form class="form-horizontal" id="submitBrandForm" action="php_action/createBrand.php" method="POST">
	      ...
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	<label for="brandName" class="col-sm-3 control-label">Nombre Marca: </label>
	        ...
	        <div class="form-group">
	        	<label for="brandStatus" class="col-sm-3 control-label">Estatus: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
    	...
    	<form class="form-horizontal" id="editBrandForm" action="php_action/editBrand.php" method="POST">
	      ...
	      <div class="modal-body">
		      ...
		      <div class="edit-brand-result">
		      	<div class="form-group">
		        	<label for="editBrandName" class="col-sm-3 control-label">Nombre marca: </label>
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-8">
