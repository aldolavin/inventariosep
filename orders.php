...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<?php } else if($_GET['o'] == 'manord') { ?>
			<i class="glyphicon glyphicon-edit"></i> Admin Salida
		<?php } else if($_GET['o'] == 'editOrd') { ?>
			<i class="glyphicon glyphicon-edit"></i> Modificar Salida
		<?php } ?>
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    <label for="orderDate" class="col-sm-2 control-label">Fecha Salida</label>
			    <div class="col-sm-10">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="areaName" name="areaName" placeholder="Area" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">Nombre recibe</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Nombre" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label">Telefono</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="Telefono" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->			  
			  			...
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
							...
							<td style="padding-left:40px;">
			  				...
			  				<td style="padding-left:20px;">
			  					<div class="form-group">
			  					<input type="number" name="quantity[]" id="quantity<?php echo $x; ?>" oninput="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control" min="1" />
			  					</div>
			  				</td>
			  				<td style="padding-left:20px;">			  					
			  ...
			  <div class="col-md-6">
			  	<!-- <div class="form-group">
				    <label for="paid" class="col-sm-3 control-label">Cantidad pagada</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="paid" name="paid" autocomplete="off" onkeyup="paidAmount()" />
				    </div>
				  </div> //--> <!--/form-group-->			  
				  <!--<div class="form-group">
				    <label for="due" class="col-sm-3 control-label">Cantidad debida</label>
				    <div class="col-sm-9">
				  ...
				  <!-- <div class="form-group">
				    <label for="clientContact" class="col-sm-3 control-label">Tipo pago</label>
				    <div class="col-sm-9">
				  ...
				  <!-- <div class="form-group">
				    <label for="clientContact" class="col-sm-3 control-label">Estatus pago</label>
				    <div class="col-sm-9">
			  ...
			  <div class="form-group submitButtonFooter">
			    ...
			    <button type="button" class="btn btn-default" onclick="addRow()" id="addRowBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-plus-sign"></i> Agregar fila </button>
			      ...
			      <button type="submit" id="createOrderBtn" data-loading-text="Loading..." class="btn btn-success"><i class="glyphicon glyphicon-ok-sign"></i> Guardar cambios</button>

			      <button type="reset" class="btn btn-default" onclick="resetOrderForm()"><i class="glyphicon glyphicon-erase"></i> Reestablecer</button>
			    </div>
			  </div>
			</form>
		<?php } else if($_GET['o'] == 'manord') { 
